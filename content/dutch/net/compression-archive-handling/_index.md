---
"description": "Leer werken met gecomprimeerde archieven en voer extractiebewerkingen uit met GroupDocs.Conversion voor .NET."
...
### [RAR-bestanden efficiënt extraheren met GroupDocs.Conversion in .NET: een handleiding voor ontwikkelaars](./extract-rar-files-groupdocs-conversion-net/)
Leer hoe u efficiënt bestanden uit RAR-archieven kunt extraheren met GroupDocs.Conversion voor .NET. Volg deze handleiding voor tips over installatie, implementatie en integratie.

### [RAR-bestanden converteren naar PDF en comprimeren naar ZIP met GroupDocs.Conversion voor .NET](./convert-rar-to-pdf-compress-groupdocs-net/)
Leer hoe u RAR-bestanden naar PDF converteert en comprimeert naar ZIP-formaat met GroupDocs.Conversion voor .NET. Deze handleiding bevat stapsgewijze instructies met codefragmenten.
