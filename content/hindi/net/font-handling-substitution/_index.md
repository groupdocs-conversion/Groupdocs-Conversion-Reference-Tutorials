---
"description": ".NET के लिए GroupDocs.Conversion के साथ दस्तावेज़ रूपांतरण के दौरान फ़ॉन्ट प्रबंधन के लिए चरण-दर-चरण ट्यूटोरियल।"
"title": "GroupDocs.Conversion .NET के लिए फ़ॉन्ट हैंडलिंग और प्रतिस्थापन ट्यूटोरियल"
"url": "/hi/net/font-handling-substitution/"
"weight": 22
type: docs
---
...
### [.NET के लिए GroupDocs.Conversion का उपयोग करके फ़ॉन्ट प्रतिस्थापन के साथ Word को PDF में परिवर्तित करें](./convert-word-to-pdf-font-substitution-groupdocs-conversion/)
...
### [GroupDocs.Conversion के साथ .NET में मास्टर PDF फ़ॉन्ट प्रतिस्थापन: एक व्यापक गाइड](./groupdocs-conversion-pdf-font-substitution-dotnet/)
